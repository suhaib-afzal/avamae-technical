...
import { isExpectedResponse, postContactInfo, postContactInfoFails, postContactInfoSucceeds } from "./postContactInfo"
...
export const ContactForm: React.FC<ContactFormProps> = ({isMobile, switchToFormSuccess, switchToFormFailure}) => {
  ...
  return <Formik initialValues={{
    ...
    onSubmit={async (values, actions) => {
      ...
      const response = await postContactInfoFails(details);
